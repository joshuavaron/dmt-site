...
type ClipMode = "diagonal" | "diagonal-reverse" | "none";

// "diagonal" leans the cut one way; "diagonal-reverse" mirrors it. Stacking a
// run of same-side spreads and alternating diagonal / diagonal-reverse makes the
// cut edges meet at each seam (a continuous chevron) instead of stepping or
// crossing into a bowtie.
const CLIP_LEFT = "polygon(0 0, 100% 0, 86% 100%, 0 100%)";
const CLIP_RIGHT = "polygon(14% 0, 100% 0, 100% 100%, 0 100%)";
const CLIP_LEFT_REVERSE = "polygon(0 0, 86% 0, 100% 100%, 0 100%)";
const CLIP_RIGHT_REVERSE = "polygon(0 0, 100% 0, 100% 100%, 14% 100%)";
...
interface DiagonalSpreadProps {
  ...
  /** Diagonal clip on the photo, its mirror, or no clip. Defaults to "diagonal". */
  clip?: ClipMode;
