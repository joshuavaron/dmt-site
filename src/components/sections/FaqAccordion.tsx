      ...
      >
        <span
          ...
          className={`text-base md:text-lg leading-snug transition-colors ${
            isOpen
              ? "text-[#012169]"
              : "text-neutral-900 group-hover:text-[#012169]"
          }`}
        >
          {question}
        </span>
        <div
          className={`shrink-0 w-8 h-8 rounded-full flex items-center justify-center transition-all duration-300 ${
            isOpen
              ? "bg-[#012169] text-white rotate-45"
              : "bg-neutral-100 text-neutral-500 group-hover:bg-[#012169]/10 group-hover:text-[#012169]"
          }`}
        >
